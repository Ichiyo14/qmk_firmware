 ...
 *   FN2 + S     → Win+Shift+S   スクリーンショット（範囲切り取り）
...
[FN2] = LAYOUT_jis_71(
     ...
     _______,  _______,  _______,  G(KC_E),  KC_F2,    _______,  _______,  _______,  _______,  _______,  KC_PSCR,  _______,  _______,                     _______,
     _______,  C(KC_A),  G(S(KC_S)), _______, C(KC_F),  _______,  _______,  _______,  _______,  G(KC_L),  _______,  _______,  _______,  _______,           _______,
